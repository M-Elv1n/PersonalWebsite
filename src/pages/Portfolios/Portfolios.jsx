...
import portfoliosLogo1 from '../../assert/img/portfolios_page.png';
import portfoliosLogo2 from '../../assert/img/portfolios_page(1).png';
import portfoliosLogo3 from '../../assert/img/portfolios_page(2).png';
import portfoliosLogo4 from '../../assert/img/portfolios_page(3).png';
import portfoliosLogo5 from '../../assert/img/portfolios_page(4).png';
import portfoliosLogo6 from '../../assert/img/portfolios_page6.png';
